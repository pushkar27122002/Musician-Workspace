      ...
      <div className="flex items-center justify-center h-screen bg-gray-900 text-white">
        <div className="w-full max-w-screen-lg mx-auto p-8">
          <div className="flex justify-between mb-8">
            <div>
              <button className="bg-transparent border border-white rounded px-4 py-2 mr-4"></button>
              <button className="bg-blue-600 text-white px-4 py-2 rounded-md mr-4"><a href="/uploadsong" className= "hover:underline">Upload Songs</a></button>
              <button className="bg-blue-600 text-white px-4 py-2 rounded-md mr-4 "><a href="/playlist/create" className= "hover:underline">Create Playlist</a></button>
              <button className="bg-blue-600 text-white px-4 py-2 rounded-md mr-4"><a href="/mySongs" className= "hover:underline">MY Songs</a></button>
              <button className="bg-blue-600 text-white px-4 py-2 rounded-md mr-4"><a href="/myPlaylist" className= "hover:underline">My Playlist</a></button>
            </div>
          </div>
          ...
          <div className="flex justify-center mb-8">
            <div className="bg-gray-800 rounded-lg p-6 flex items-center justify-between">
              ...
              <button className="bg-blue-600 text-white px-4 py-2 rounded-md"><a href="/searchSong" className= "hover:underline">Search Songs/Artist</a></button>
            </div>
          </div>
